...
{
    const string DIR = "/home/khjtony/Documents/workspace/opencv/myMotion/pics/"; // directory where the images will be stored
    const string EXT = ".jpg"; // extension of the images
    const int DELAY = 100; // in mseconds, take a picture every 1/2 second
    const string LOGFILE = "/home/khjtony/Documents/workspace/opencv/myMotion/pics/";
